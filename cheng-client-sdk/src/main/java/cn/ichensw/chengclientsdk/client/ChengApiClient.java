package cn.ichensw.chengclientsdk.client;
...
import static cn.ichensw.chengclientsdk.utils.SignUtils.genSign;

/**
 * API 调用
 */
public class ChengApiClient {

    public static String GATEWAY_HOST = "http://124.222.29.214:8090";
    ...
    public ChengApiClient(String accessKey, String secretKey) {
