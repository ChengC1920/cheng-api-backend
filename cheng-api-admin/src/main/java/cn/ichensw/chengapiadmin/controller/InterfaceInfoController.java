package cn.ichensw.chengapiadmin.controller;

import cn.hutool.json.JSONUtil;
import cn.ichensw.chengapiadmin.annotation.AuthCheck;
import cn.ichensw.chengapiadmin.config.GatewayConfig;
import cn.ichensw.chengapiadmin.exception.BusinessException;
import cn.ichensw.chengapiadmin.exception.ThrowUtils;
import cn.ichensw.chengapiadmin.service.InterfaceInfoService;
import cn.ichensw.chengapiadmin.service.UserService;
import cn.ichensw.chengapicommon.common.*;
import cn.ichensw.chengapicommon.constant.CommonConstant;
import cn.ichensw.chengapicommon.constant.UserConstant;
import cn.ichensw.chengapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import cn.ichensw.chengapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import cn.ichensw.chengapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import cn.ichensw.chengapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import cn.ichensw.chengapicommon.model.entity.InterfaceInfo;
import cn.ichensw.chengapicommon.model.entity.User;
import cn.ichensw.chengapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        ChengApiClient chengApiClient = interfaceInfoService.getChengApiClient(request);
        // 设置网关地址
        chengApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = chengApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = chengApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
